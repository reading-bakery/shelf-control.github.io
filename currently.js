        ...
        books.forEach(book => {
            ...
            bookDiv.querySelector(".btn-finish").addEventListener("click", async () => {
                ...
                const themenArr = await openCheckboxModal("themenModal", [
                    "Abenteuer","Ableismus","Antisemitismus","Alkoholismus","Armut","Bücher", "Behinderung", "Coming of Age","DDR","Demenz/Alzheimer","Depression","Diktatur","Ehebruch/Betrug","Eifersucht","Eltern-Kind-Beziehung","Elternschaft","Emanzipation","Essen","Familie","Female Rage","Feminismus","Feminizid","Freundschaft","Geheimnisse","Generationen","Gerichtsverfahren","Geschwister","Gesellschaft","Gewalt","Holocaust","Homophobie","Identität/Herkunft","Klassismus","Krankheit","Krieg","Kunst","Liebe","Magie","Manipulation","Misogynie","Missbrauch","Mord","Musik","Nachkriegszeit","Natur","Philosophie","Politik","Psychologisch","Queer","Rassismus","Religion","Rolle der Frau","Sexismus","Spionage","Sprache","Soziologie","Tod","Trauer","Trauma","Toxische Beziehung","Vergewaltigung","Verrat","Wissenschaft","Zeitreise"
                ], "Themen", true);
                const themenStr = themenArr.join(", ");

                const stimmungArr = await openCheckboxModal("stimmungModal", ["Traurig","Langweilig","Lustig/Humorvoll","Aufwühlend","Spannend","Melancholisch","Informativ","Spicy","Nachdenklich","Düster","Gruselig","Cozy/Gemütlich","Ruhig","Herausfordernd/Komplex","Verwirrend","Eklig","Überraschend","Dramatisch","Wütend"], "Stimmung", true);
