...
document.addEventListener('DOMContentLoaded', () => {
    const DATA_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTXx02YVtknMhVpTr2xZL6jVSdCZs4WN4xN98xmeG19i47mqGn3Qlt8vmqsJ_KG76_TNsO0yX0FBEck/pub?gid=1702643479&single=true&output=csv';
    const contentArea = document.createElement('div');
    contentArea.id = 'currently-reading-books';
    document.body.appendChild(contentArea); // Appends the content area to the body
